...
```{r life-cycle, fig.cap="Life cycle of \\textit{Mimulus guttatus} taken from \\cite{@Peterson2016}. Seedlings and rosettes are sexually reproductive flowering stages. Rosettes are asexually produced clones."}
knitr::include_graphics("_images/m.guttatus-lifecycle-peterson2016.png")
```

## The model {#methods-model}

The model was created as an R package, and is available here along with simulation scripts used for this work, as well as the data output: https://github.com/rosemckeon/honours-project. 
