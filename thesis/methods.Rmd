...
The model was created as an open source R package *{sploidy}*, and is available along with the simulation scripts used for this work and the raw data, on Github [@Rsploidy]. 
