...
## Limited mate-choice for polyploids {#intro-limited-mate-choice}
...
Here we aim to quanitify the selection which works against the evolution of polyploidy via limiting mate choice by pollen-swamping, by testing how high the rate of whole-genome duplication would need to be in order to overcome this selection and lead to the fixation of polyploidy. Or, if indeed, this even is the case. Will increasing the rate of whole-genome duplication lead to the fixation of polyploidy? And, if so, at what threshold point does this occur? 

In addition, we aim to discover how varying the starting population size affects these results. Does an established population react in the same way to increased duplication rates as a pioneering population entering an empty landscape? 